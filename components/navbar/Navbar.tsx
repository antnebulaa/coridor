...
const Navbar: React.FC<NavbarProps> = ({ currentUser }) => {
    ...
    return (
        <div
            data-navbar
            className={`${isHomePage ? 'fixed' : 'relative'} w-full z-9998 pt-safe bg-background ${!isHomePage ? 'hidden md:block' : ''} transition-transform duration-300 ease-out ${isHomePage && hideNav ? '-translate-y-full md:translate-y-0' : ''}`}
