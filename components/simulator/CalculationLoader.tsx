...
const STEP_DELAY = 450; // ms between each step appearing
const TOTAL_DURATION = 1800; // ms total
...
export function CalculationLoader({ projectionYears, onComplete }: CalculationLoaderProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 md:py-24">
      ...
      {/* Title */}
      <h3
        className="text-xl md:text-2xl text-neutral-900 dark:text-white mb-8"
      ...
      {/* Progress bar */}
      <div className="w-64 h-1.5 bg-neutral-200 dark:bg-neutral-700 rounded-full overflow-hidden mb-8">
        <div
