...
import KPICards from "@/app/properties/components/analytics/KPICards";
import CashflowChart from "@/app/properties/components/analytics/CashflowChart";
        ...
        <Container>
            <div className="pb-20 space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <PageHeader
                        title={`Bonjour ${currentUser.firstName || 'Adrien'} 👋`}
                        subtitle={['Prêt à encaisser des loyers ?', 'Tout roule aujourd\'hui !', 'Les affaires reprennent !', 'Une belle journée pour investir.'][Math.floor(Math.random() * 4)]}
                    />
                    ...
                    <div className="bg-white p-5 rounded-xl border border-neutral-200 flex flex-col gap-4">
                        ...
                        <div className="space-y-2">
                            <Link href="/dashboard/applications" className="flex items-center justify-between p-2 hover:bg-neutral-50 rounded-lg transition group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-medium text-neutral-700">Candidatures</span>
                                </div>
                            ...
                            <Link href="/" className="flex items-center justify-center p-2 hover:bg-neutral-50 rounded-lg transition group">
                                <div className="flex items-center gap-3 w-full">
                                    ...
                                    <span className="text-sm font-medium text-neutral-700">Visites à venir</span>
                                </div>
                        ...
                        <div className="mt-auto border-t border-neutral-100 pt-3">
                            <div className="text-xs text-neutral-500">
                                {operationalStats?.totalUnits || 0} logements gérés
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-4">
                        <Link href="mailto:support@coridor.com" className="bg-linear-to-br from-neutral-900 to-neutral-800 rounded-xl p-5 text-white hover:opacity-95 transition group">
                            ...
                            <p className="text-sm text-neutral-300 mb-4">
                                Une question ou un problème ? Contactez notre équipe support.
                            </p>
