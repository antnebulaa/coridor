                    ...
                    {mostRelevantApplication ? (
                        <div className="bg-white border border-neutral-200 rounded-2xl p-6 shadow-sm">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-xl font-medium">Suivi de candidature</h2>
                            ...
                            <div className="relative flex items-center justify-between w-full">
                                ...
                                {/* Steps */}
                                {[
                                    { label: "Envoyé", status: ['SENT', 'PENDING'] },
                                    { label: "Visite", status: ['VISIT_PROPOSED', 'VISIT_CONFIRMED'] },
                                    { label: "Validation", status: ['ACCEPTED'] },
                                    { label: "Bail", status: ['SIGNED'] } // Lease status check needed
                                ].map((step, idx) => {
