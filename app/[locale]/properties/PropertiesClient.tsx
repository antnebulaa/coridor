...
const PropertiesClient: React.FC<PropertiesClientProps> = ({
    ...
    const computeCounts = useCallback(() => {
        const counts = { ALL: 0, VACANT: 0, PUBLISHED: 0, OCCUPIED: 0 };
    ...
    const filters = [
        { label: t('filters.all'), value: 'ALL', count: counts.ALL },
        { label: t('filters.vacant'), value: 'VACANT', count: counts.VACANT },
        { label: t('filters.published'), value: 'PUBLISHED', count: counts.PUBLISHED },
        { label: t('filters.occupied'), value: 'OCCUPIED', count: counts.OCCUPIED },
    ];
                ...
                {(!properties || properties.length === 0) ? (
                    ...
                    properties.map((property) => {
                        ...
                        if (isColoc) {
                            ...
                            const mainListing = property.rentalUnits?.flatMap(u => u.listings || []).find(l => l.rentalUnit.type === 'ENTIRE_PLACE');
